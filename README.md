...
By analyzing metadata such as genres, keywords, cast, crew, and descriptions, the system identifies similarities between movies and recommends titles closest to the one selected by the user.
...
movie_recommendation.ipynb — Main notebook with code, processing, similarity model, and recommendation output
...
Convert it into a vector using TF-IDF or CountVectorizer
...
Add movie posters, ratings, and overviews to the output
